"""
scripts/data_preparation/prepare_histo_inventory.py

This script reads inventory data from the data/raw folder, cleans the data, 
...
> py scripts\data_prep_inventory.py
...
# Now we're directly importing from the utils directory
...
def main() -> None:
    """
    Main function for processing inventory data.
    """

    logger.info("==================================")
    logger.info("STARTING data_prep_inventory.py")
    logger.info("==================================")
    ...
    input_file = "histo_inventory.csv"
    output_file = "histo_inventory_prepared.csv"
    ...
    logger.info("==================================")
    logger.info("FINISHED prepare_inventory_data.py")
    logger.info("==================================")
